  ...
  return (
    <div>
      ...
      <section className="relative ">
        <div className="w-full  mx-auto px-6 pb-4  md:py-16 grid md:grid-cols-2  items-center">
          {/* Left Side - Image */}
      ...
      <section className="w-full bg-[#F0F5FC] py-5 md:py-10 text-center">
        <div className="max-w-6xl mx-auto px-6">
              ...
              <div
                ...
                className={`flex flex-col items-center cursor-pointer transition-all duration-300 px-6 ${
                  activeTab === tab.id
                    ...
                    : "text-[#0b2341] opacity-70 hover:opacity-100"
                }`}
              >
                <div className="mb-4 text-4xl">{tab.icon}</div>
                <h3 className="font-bold text-xl tracking-wide">{tab.title}</h3>
                {activeTab === tab.id && (
                  <div className="h-[2px] w-10 bg-[#F7C600] mt-2 rounded-full"></div>
                )}
              </div>
            ))}
          </div>
          ...
          {/* Tab Content */}
          <div className="max-w-5xl mx-auto mt-12 text-[#333] text-xl leading-relaxed animate-fadeIn">
      ...
      <section
        ...
        className="relative  bg-center bg-cover w-full pb-3 md:py-20"
      >
